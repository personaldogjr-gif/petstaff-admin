          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-12">
                  ...
                  <label class="form-label" for="type">{{ $t('commission.lbl_type_commission') }}<span class="text-danger">*</span></label>
                  <Multiselect v-model="type" :options="selectedType.options" id="type" autocomplete="off"></Multiselect>
