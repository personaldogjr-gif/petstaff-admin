          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-12">
                ...
                <h6><b>Configurações de Formato de Moeda</b></h6>
                ...
                <div class="form-group">
                  ...
                  <select class="form-select" v-model="currency_position">
                    ...
                    <option value="left_with_space">Esquerda com Espaço</option>
                    <option value="right_with_space">Direita com Espaço</option>
                  </select>
                </div>
