<template>
  <form @submit="formSubmit">
    ...
    <InputField :label="$t('setting_mobile_page.lbl_primary')" placeholder="Primário" v-model="primary" :errorMessage="errors.primary"></InputField>
    <InputField :label="$t('setting_mobile_page.lbl_secondary')" placeholder="Secundário" v-model="secondary" :errorMessage="errors.secondary"></InputField>
