<template>
  <form @submit="formSubmit">
    <CardTitle title="Perfil Social" icon="fas fa-users"></CardTitle>

    <InputField :label="$t('setting_social_page.lbl_fb_url')" :is-required="true"  placeholder="Facebook URL" v-model="facebook_url" :errorMessage="errors.facebook_url" :errorMessages="errorMessages.facebook_url"></InputField>

    <InputField :label="$t('setting_social_page.lbl_twitter_url')" :is-required="true"  placeholder="Twitter URL" v-model="twitter_url" :errorMessage="errors.twitter_url" :errorMessages="errorMessages.twitter_url"></InputField>

    <InputField :label="$t('setting_social_page.lbl_insta_url')"  :is-required="true" placeholder="Instagram URL" v-model="instagram_url" :errorMessage="errors.instagram_url" :errorMessages="errorMessages.instagram_url"></InputField>
    ...
    <InputField :label="$t('setting_social_page.lbl_youtube_url')" placeholder="Youtube URL" v-model="youtube_url" :errorMessage="errors.youtube_url"></InputField>
