<template>
  <form @submit="formSubmit">
    ...
    <CardTitle title="Configurações Diversas" icon="fa-solid fa-screwdriver-wrench"></CardTitle>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <flat-pickr placeholder="Duração (Min)" id="slot_duration" class="form-control" v-model="slot_duration" :value="slot_duration" :config="config"></flat-pickr>
      ...
      <div class="col-md-4">
        <label class="form-label">{{ $t('setting_language_page.lbl_timezone') }} <span class="badge bg-danger">Breve</span></label>
