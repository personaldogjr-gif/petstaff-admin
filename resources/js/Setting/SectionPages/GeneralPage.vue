<template>
  <form @submit="formSubmit">
    <div class="d-flex justify-content-between align-items-center">
      <CardTitle title="Geral" icon="fas fa-cube"></CardTitle>
      <div>
        <a href="#" class="btn btn-primary float-right me-3" @click="clearcache()" :class="{ disabled: IS_LOADING_PURGE_CACHE }" v-bind:disabled="IS_LOADING_PURGE_CACHE">
          ...
          <div v-else>
            <i class="fa-solid fa-arrow-rotate-left mx-2"></i>Limpar Cache
          </div>
        </a>
        ...
        <a  v-if="role() == 'admin'" href="#" class="btn btn-primary float-right  ml-2" @click="reloaddatabase()" :class="{ disabled: IS_LOADING_DATABASE }" v-bind:disabled="IS_LOADING_DATABASE">
          ...
          <div v-else>
            <i class="fa-solid fa-arrow-rotate-left mx-2"></i>Importar Dados
          </div>
        </a>
     </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-8">
            <div class="d-flex align-items-center gap-2">
              ...
              <input type="button" class="btn btn-danger mb-5" name="remove" value="Remover" @click="removeLogo()" v-if="logo" />
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-8">
            <div class="d-flex align-items-center gap-2">
              ...
              <input type="button" class="btn btn-danger mb-5" name="remove" value="Remover" @click="removeMiniLogo()" v-if="mini_logo" />
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-8">
            <div class="d-flex align-items-center gap-2">
              ...
              <input type="button" class="btn btn-danger mb-5" name="remove" value="Remover" @click="removeDarkLogo()" v-if="dark_logo" />
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-8">
            <div class="d-flex align-items-center gap-2">
              ...
              <input type="button" class="btn btn-danger mb-5 mb-5" name="remove" value="Remover" @click="removeDarkMiniLogo()" v-if="dark_mini_logo" />
            </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-8">
            <div class="d-flex align-items-center gap-2">
              ...
              <input type="button" class="btn btn-danger mb-5" name="remove" value="Remover" @click="removeFavicon()" v-if="favicon" />
            </div>
