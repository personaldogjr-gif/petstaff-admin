<template>
  <form @submit="formSubmit">
    <CardTitle title="Configurações de fatura" icon="fa-solid fa-file-invoice"></CardTitle>
    <div class="row">
      ...
      <InputField class="col-12" :is-required="false" :label="$t('setting_invoice.lbl_spacial_note')" placeholder="Digite sua nota especial" v-model="spacial_note" :error-message="errors.spacial_note"></InputField>
    </div>
