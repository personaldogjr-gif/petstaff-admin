...
<template>
  <form @submit="formSubmit">
    <div>
      <CardTitle title="Código Customizado" icon="fa-solid fa-file-code"></CardTitle>
    </div>
    <TextArea :label="$t('setting_custom_code.lbl_css_name')" placeholder="Código CSS" v-model="custom_css_block" :errorMessage="errors.custom_css_block"> </TextArea>
    <TextArea :label="$t('setting_custom_code.lbl_js_name')" placeholder="Código JS" v-model="custom_js_block" :errorMessage="errors.custom_js_block"> </TextArea>
