<template>
  <form @submit="formSubmit">
    <div class="col-md-12 d-flex justify-content-between">
      <CardTitle title="Configurações de Idioma" icon="fa fa-language"></CardTitle>
       <button type="submit" class="btn btn-primary d-flex align-items-center gap-1 float-right">Salvar<i class="icon-disk"></i></button>
    </div>
