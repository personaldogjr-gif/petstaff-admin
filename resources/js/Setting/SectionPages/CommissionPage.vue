<template>
  <CardTitle title="Comissões" icon="fa-solid fa-bars">
        ...
        <tbody>
          <tr v-for="(item, index) in tableList" :key="index">
            ...
            <th>
              ...
              <button type="button" class="fs-4 text-danger border-0 bg-transparent" @click="destroyData(item.id, 'Tem certeza de que deseja excluí-lo?')" data-bs-toggle="tooltip"><i class="icon-delete"></i></button>
            </th>
          </tr>
        </tbody>
      </template>
