<template>
  <form @submit="formSubmit">
    <div class="col-md-12 d-flex justify-content-between">
      <div class="d-flex">
        <CardTitle title="Feriados" icon="fa-solid fa-calendar-check"></CardTitle>
      </div>
    </div>
    ...
    <div class="row mb-2">
      <div class="col-12">
        <div class="form-group" v-if="branch.options.length > 1">
          ...
          <Multiselect id="branch_id" v-model="branch_id" placeholder="Selecione a filial" v-bind="singleSelectOption" :options="branch.options" @select="branchSelect" class="form-group"></Multiselect>
