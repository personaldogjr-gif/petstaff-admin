            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Criar Gerente</h1>
                    ...
                    <div class="modal-body">
                        <div class="row" id="form-offcanvas">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <InputField type="password" class="col-md-6" :is-required="true" label="Senha" placeholder="" v-model="password" :error-message="errors['password']" :error-messages="errorMessages['password']"></InputField>

                            <InputField type="password" class="col-md-6" :is-required="true" label="Confirmar Senha" placeholder="" v-model="confirm_password" :error-message="errors['confirm_password']" :error-messages="errorMessages['passwconfirm_passwordord']"></InputField>
                            <div class="form-group col-md-12">
                              <label for="" class="form-label w-100">Gênero</label>
                    ...
                    <div class="modal-footer">
                      <button type="submit" class="btn btn-primary">Salvar</button>
                        <button type="button" class="btn btn-outline-primary d-block" data-bs-dismiss="modal"><i class="fa-solid fa-angles-left"></i>Fechar</button>
                    </div>
                </div>
            </div>
        </div>
