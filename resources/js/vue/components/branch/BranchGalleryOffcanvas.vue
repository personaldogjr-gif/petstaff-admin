    ...
    <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="branch-gallery-form" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-footer">
        ...
        <div class="d-grid gap-3 p-3">
          <button class="btn btn-primary d-block"><i class="fa-solid fa-floppy-disk mx-2"></i>Atualizar</button>
          <button class="btn btn-outline-primary d-block" type="button" data-bs-dismiss="offcanvas"><i class="fa-solid fa-angles-left"></i>Fechar</button>
        </div>
      </div>
    </div>
  </form>
