<template>
    <form @submit.prevent="formSubmit">
        <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="staff-assign-form" aria-labelledby="form-offcanvasLabel">
            ...
            <div class="offcanvas-body">
                <div class="d-flex flex-column">
                    <div class="mb-4">
                        <Multiselect v-model="assign_ids" placeholder="Selecione a filial" :value="assign_ids" :canClear="false" v-bind="staffs" @select="selectEmployee" id="employees_ids">
