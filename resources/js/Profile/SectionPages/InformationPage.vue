<template>
  <form @submit="formSubmit">
    <div class="d-flex justify-content-between align-items-center">
      <CardTitle title="Informações Pessoal" icon="fa-solid fa-user"></CardTitle>
    </div>
    <div class="row">
      <div class="col-12 row">
        ...
        <div class="col-md-4 text-center">
          ...
          <div class="d-flex align-items-center justify-content-center gap-2">
            ...
            <label class="btn btn-info" for="logo">Enviar</label>
            <input type="button" class="btn btn-danger" name="remove" value="Remover" @click="removeLogo()"
              v-if="ImageViewer" />
          </div>
