<template>
  <form @submit="formSubmit">
    <div class="d-flex justify-content-between align-items-center">
      <CardTitle title="Configurações de Filial" icon="fa-solid fa-code-branch"></CardTitle>
    </div>
    <div class="row">
      <div class="col-12 row">
            ...
            <div class="form-group col-md-6">
              ...
              <div class="btn-group w-100" role="group" aria-label="Exemplo Básico">
            ...
            <div class="form-group col-md-6">
              ...
              <div class="d-flex w-100 gap-3" role="group" aria-label="Checkbox Básico">
