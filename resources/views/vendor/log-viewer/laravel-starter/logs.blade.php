        ...
        <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-secondary mr-auto" data-bs-dismiss="modal">Fechar</button>
                    <button type="submit" class="btn btn-sm btn-danger" data-loading-text="Carregando&hellip;">Apagar</button>
                </div>
            </div>
        </form>
    </div>
    ...
    $(function() {
        ...
        $("a[href='#delete-log-modal']").on('click', function(event) {
            ...
            deleteLogModal.find('.modal-body p').html(
                'Tem certeza que quer <span class="badge bg-danger">Apagar</span> esse arquivo <span class="badge text-bg-warning">' + date + '</span> ?'
            );
