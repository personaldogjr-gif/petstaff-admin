        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="float-end">
                            <a href="{{route("backend.$module_name.destroy", $$module_name_singular)}}" class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-bs-toggle="tooltip" title="{{__('labels.backend.delete')}}"> <i class="icon-delete"></i></a>
                            <x-backend.buttons.return-back>Cancelar</x-backend.buttons.return-back>
                        </div>
                    </div>
                </div>
                {{ html()->form()->close() }}
