...
<head>
    ...
    <script>
     ...
     <script>
       ...
       window.auth_id = @json($id ?? auth()->id())
...
<body class="{{ !empty(getCustomizationSetting('card_style')) ? getCustomizationSetting('card_style') : '' }} {{ auth()->user()->user_setting['theme_scheme'] ?? '' }}">
    ...
    <div class="main-content wrapper">
        ...
        <div class="slideouticons pr-hide">
            <label for="togglebox" class="mainlabel"><i class="icon-pet"></i></label>
            <div class="iconswrapper">
                <ul class="list-inline m-0">
                  @hasPermission('add_boarding_booking')
                    <li><a href="{{ route('backend.bookings.datatable_view', ['type' => 'new']) }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Nova Reseva de Hospedagem"><i class="icon icon-Boarding"></i></a></li>
                    @endhasPermission
                    @hasPermission('add_veterinary_booking')
                    <li><a href="{{ route('backend.veterinary.datatable_view', ['type' => 'new']) }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Nova Reserva Veterinária"><i class="icon icon-Veterinary"></i></a></li>
                    @endhasPermission
                    @hasPermission('add_grooming_booking')
                    <li><a href="{{ route('backend.grooming.datatable_view', ['type' => 'new']) }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Nova Reserva de Banho e Tosa"><i class="icon icon-Grooming"></i></a></li>
                    @endhasPermission
                    @hasPermission('add_training_booking')
                    <li><a href="{{ route('backend.training.datatable_view', ['type' => 'new']) }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Nova Reserva de Treinamento"><i class="icon icon-Training"></i></a></li>
                    @endhasPermission
                    @hasPermission('add_walking_booking')
                    <li><a href="{{ route('backend.walking.datatable_view', ['type' => 'new']) }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Nova Reserva de Passeio"><i class="icon icon-Walking"></i></a></li>
                    @endhasPermission
                    @hasPermission('add_daycare_booking')
                    <li><a href="{{ route('backend.daycare.datatable_view', ['type' => 'new']) }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Nova Reserva de Creche"><i class="icon icon-icon-day-care"></i></a></li>
                   @endhasPermission
                </ul>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content" data-iq-modal="content">
                <div class="modal-header">
                    <h5 class="modal-title" data-iq-modal="title">Título</h5>
