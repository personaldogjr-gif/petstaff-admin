                ...
                <table id="datatable" class="table table-striped border table-responsive notification-table">
                    ...
                    <tbody>
                        ...
                        <tr class="{{$row_class}}">
                            ...
                            <td>
                                <a onclick="remove_notification()" id="delete-{{$module_name}}-{{$module_name_singular->id}}" class="fs-4 text-danger" data-type="ajax" data-method="DELETE" data-token="{{csrf_token()}}" data-bs-toggle="tooltip" title="{{__('Deletar')}}" data-confirm="{{ __('messages.are_you_sure?') }}"> <i class="icon-delete"></i></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
