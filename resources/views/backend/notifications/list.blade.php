                    ...
                    <div class="list-item d-flex">
                        ...
                        <div class="list-style-detail">
                          @if($notification->data['data']['notification_type']=='new_booking')
                            <p class="text-body mb-1">Reserva recebida para <span class="text-primary">{{ ($notification->data['data']['booking_services_names']) }}</span> serviço por <span class="text-black">{{ ($notification->data['data']['user_name']) }}</span></p>
                            <div class="d-flex justify-content-between">
                            ...
                            @elseif($notification->data['data']['notification_type']=='accept_booking')
                             ...
                             <p class="text-body mb-1">Reserva <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> foi aceita.</p>
                              <div class="d-flex justify-content-between">
                               <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>     
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
                            ...
                            @elseif($notification->data['data']['notification_type']=='reject_booking')
                             ...
                             <p class="text-body mb-1">Reserva <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> foi rejeitada.</p>
                              <div class="d-flex justify-content-between">
                               <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>     
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
                             ...
                             <p class="text-body mb-1">Reserva <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> foi completada.</p>
                              <div class="d-flex justify-content-between">
                               <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>     
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
                             ...
                             <p class="text-body mb-1">Reserva <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> foi cancelada.</p>
                              <div class="d-flex justify-content-between">
                               <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>     
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
                             ...
                             <p class="text-body mb-1">Solicitação de Reserva <span class="text-primary">#{{ ($notification->data['data']['id']) }}</span> foi aceita.</p>
                              <div class="d-flex justify-content-between">
                               <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>     
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
                    ...
                    <div class="list-item d-flex">
                        <div class="me-3 mt-1">
                         ...
                         <div class="list-style-detail">
                            ...
                            <p class="text-body mb-1">Order <span class="text-black">{{ ($notification->data['data']['order_code']) }}</span> foi Accepted.</p>
                            <div class="d-flex justify-content-between">
                                <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
                            ...
                            <p class="text-body mb-1">Order <span class="text-black">{{ ($notification->data['data']['order_code']) }}</span> foi Processing.</p>
                            <div class="d-flex justify-content-between">
                                <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
                            ...
                            <p class="text-body mb-1">Order <span class="text-black">{{ ($notification->data['data']['order_code']) }} </span> foi Delivered.</p>
                            <div class="d-flex justify-content-between">
                                <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
                            ...
                            <p class="text-body mb-1">Order <span class="text-black">{{ ($notification->data['data']['order_code']) }} </span> foi Cancelled.</p>
                            <div class="d-flex justify-content-between">
                                <p class="text-body">{{ $notification->created_at->format('d/m/Y') }}</p>
                                <p class="text-body">{{ $notification->created_at->format('h:i A') }}</p>
                            </div>
