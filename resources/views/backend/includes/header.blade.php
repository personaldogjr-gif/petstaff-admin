            ...
            <div class="collapse navbar-collapse header-right-panel" id="navbarSupportedContent">
                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                    <li class="nav-item dropdown me-0 me-xl-3">
                        <div class="d-flex align-items-center mr-2 iq-font-style" role="group" aria-label="Primeiro Grupo">
                            ...
                            @role('admin')
                             <li>
                                 <a class="dropdown-item d-flex align-items-center gap-2"
                                     ...
                                     <i class="icon-Home"></i> {{ __('messages.pet_center') }}
                                 </a>
                             </li>
                           @endrole
                            <li>
