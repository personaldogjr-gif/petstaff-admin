<div class="row">
            ...
            <div class="card-body">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-flex align-items-center bg-transparent"
                                ...
                                <span class="ms-2">Transparente</span>
                            </label>
                        </div>
                        <div data-setting="radio">
                ...
                <div>
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div data-setting="radio" class="text-center">
                            ...
                            <label class="btn btn-border d-block overflow-hidden" for="navs-rounded">Arrendodado um lado</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="sidebar-default navs-rounded-all" class="btn-check" name="sidebar_menu_style" id="navs-rounded-all">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-rounded-all">Arrendodado</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="sidebar-default navs-pill" class="btn-check" name="sidebar_menu_style" id="navs-pill">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-pill">Comprimido um lado</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value=" sidebar-default navs-pill-all" class="btn-check" name="sidebar_menu_style" id="navs-pill-all">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-pill-all">Comprimido</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="left-bordered" class="btn-check" name="sidebar_menu_style" id="left-bordered" checked>
                            <label class="btn btn-border d-block overflow-hidden" for="left-bordered">Arrendondamento Esquerdo</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="sidebar-default navs-full-width" class="btn-check" name="sidebar_menu_style" id="navs-full-width">
                            <label class="btn btn-border d-block overflow-hidden" for="navs-full-width">Largura Total</label>
                        </div>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div data-setting="checkbox">
                    <div class="d-flex align-item-center">
                        <h6 class="me-5">Esconder Menu</h6>
    ...
    <div class="col-6">
        <div class="card">
            <div class="card-body">
                <div>
                    <h6>Cor Personalizada</h6>
                    <div class="card">
                        <div class="card-body">
                            <div id="custom-color">
                                <div class="form-group d-flex justify-content-between align-items-center">
                                    <label class="" for="custom-primary-color">Primária</label>
                                ...
                                <div class="form-group d-flex d-flex justify-content-between align-items-center">
                                    <label class="" for="custom-info-color">Secundária</label>
                ...
                <hr class="hr-horizontal">
                <div>
                    <h6 class="d-inline-block mb-0 me-2">Estilo do Cartão</h6>
                ...
                <div>
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        ...
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block" for="page-layout-full-width">Largura completa</label>
                        </div>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div>
                    <h6>Estilo de Aparência</h6>
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div data-setting="checkbox">
...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <div>
                    <h6>Estilo da Barra de Navegação</h6>
                    <div class="d-grid gap-3 grid-cols-4 mb-4">
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="nav-glass" class="btn-check" name="header_navbar" id="nav-glass">
                            <label class="btn btn-border d-block overflow-hidden" for="nav-glass">Vidro</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                        ...
                        <div data-setting="radio" class="text-center">
                            ...
                            <label class="btn btn-border d-block overflow-hidden" for="navs-transparent">Transparente</label>
                        </div>
                        <div data-setting="radio" class="text-center">
                            <input type="radio" value="navs-default" class="btn-check" name="header_navbar" id="navs-default" checked>
                            <label class="btn btn-border d-block overflow-hidden" for="navs-default">Padrão</label>
                        </div>
                    </div>
                </div>
                <hr class="hr-horizontal">
                <div data-setting="checkbox">
                    <div class="d-flex">
                        <h6 class="me-5">Esconder Barra de Navegação</h6>
                        <div class="form-check form-switch">
                ...
                <div>
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block" for="footer_default">Padrão</label>
                        </div>
                        <div data-setting="radio">
                        ...
                        <div data-setting="radio">
                            ...
                            <label class="btn btn-border d-block" for="footer_glass">Vidro</label>
                        </div>
                    </div>
                </div>
            </div>
