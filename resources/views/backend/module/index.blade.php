...
@section('content')
        ...
        <div class="card-header">
            ...
            <x-slot name="toolbar">
              ...
              <div class="input-group flex-nowrap">
                ...
                <x-buttons.offcanvas target='#form-offcanvas' class=" d-flex align-items-center gap-1" title="{{ __('Criar') }} {{ __($module_title) }}">{{ __('messages.new') }}</x-buttons.offcanvas>
    ...
    <div data-render="app">
        <module-form-offcanvas
            create-title="{{ __('Criar') }} {{ __('novo') }} {{ __($module_title) }}"
