        ...
        <div class="col-lg-12">
            ...
            <div class="tab-content iq-tab-fade-up" id="nav-tab-content">
                <div class="tab-pane fade show active" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xxl-{{ auth()->user()->roles()->count() == 2 ? '4' : '3' }} col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mt-5 mb-2">{{ __('dashboard.total_product') }}</p>
                                            <h3 class="mb-0">{{ $data['top_product'] }}</h3>
                                        </div>
                                    </div>
                                </div>
                                @endif

                                @if(auth()->user()->hasRole('boarder') || auth()->user()->hasRole('vet') || auth()->user()->hasRole('groomer') || auth()->user()->hasRole('walker') || auth()->user()->hasRole('trainer') || auth()->user()->hasRole('day_taker'))
                                <div class="col-sm-6 col-xxl-4 col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <p class="mt-5 mb-2">{{ __('dashboard.total_bookings') }}</p>
                                            <h3 class="mb-0">{{ $data['bookingCount'] }}</h3>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col-sm-6 col-xxl-{{ auth()->user()->roles()->count() == 2 ? '4' : '3' }} col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mt-5 mb-2">{{ __('dashboard.total_order') }}</p>
                                            <h3 class="mb-0">{{ $data['orderCount'] }}</h3>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col-sm-6 col-xxl-4 col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <svg width="48" height="48" class="bi bi-cash-coin" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill="#9D67EF" fill-rule="evenodd" d="M11 15a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm5-4a5 5 0 1 1-10 0 5 5 0 0 1 10 0z"/>
                                                <path fill="#9D67EF" d="M9.438 11.944c.047.596.518 1.06 1.363 1.116v.44h.375v-.443c.875-.061 1.386-.529 1.386-1.207 0-.618-.39-.936-1.09-1.1l-.296-.07v-1.2c.376.043.614.248.671.532h.658c-.047-.575-.54-1.024-1.329-1.073V8.5h-.375v.45c-.747.073-1.255.522-1.255 1.158 0 .562.378.92 1.007 1.066l.248.061v1.272c-.384-.058-.639-.27-.696-.563h-.668zm1.36-1.354c-.369-.085-.569-.26-.569-.522 0-.294.216-.514.572-.578v1.1h-.003zm.432.746c.449.104.655.272.655.569 0 .339-.257.571-.709.614v-1.195l.054.012z"/>
                                                <path fill="#9D67EF" d="M1 0a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h4.083c.058-.344.145-.678.258-1H3a2 2 0 0 0-2-2V3a2 2 0 0 0 2-2h10a2 2 0 0 0 2 2v3.528c.38.34.717.728 1 1.154V1a1 1 0 0 0-1-1H1z"/>
                                                <path fill="#9D67EF" d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 5.982 5.982 0 0 1 3.13-1.567z"/>
                                            </svg>
                                            <p class="mt-5 mb-2">{{ __('dashboard.pending_booking_payout') }}</p>
                                            <h3 class="mb-0">{{ Currency::format($data['pending_service_payout']) }}</h3>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="col-sm-6 col-xxl-{{ auth()->user()->roles()->count() == 2 ? '4' : '3' }} col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mt-5 mb-2">{{ __('dashboard.pending_order_payout') }}</p>
                                            <h3 class="mb-0">{{ Currency::format($data['pending_order_payout']) }}</h3>
                                        </div>
                                    </div>
                                </div>
                                @endif
                                ...
                                @endif
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mt-5 mb-2">{{ __('dashboard.total_revenue') }}</p>
                                            <h3 class="mb-0">{{ Currency::format($data['total_revenue']) }}</h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        @if(auth()->user()->hasRole('boarder') || auth()->user()->hasRole('vet') || auth()->user()->hasRole('groomer') || auth()->user()->hasRole('walker') || auth()->user()->hasRole('trainer') || auth()->user()->hasRole('day_taker'))
                        <div class="col-xl-{{ auth()->user()->roles()->count() == 2 ? '6' : '12' }}">
                            <div class="card">
                                <div class="card-body ">
                                    
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <h5 class="card-title mb-0">{{ __('dashboard.all_bookings') }}</h5>
                                    @if($data['all_bookings']->isNotEmpty())
                                        @if(auth()->user()->hasRole('boarder'))
                                            <a href="{{ route('backend.bookings.datatable_view') }}" class="">{{ __('dashboard.view_all') }}</a>
                                        @elseif(auth()->user()->hasRole('vet'))
                                            <a href="{{ route('backend.veterinary.datatable_view') }}" class="">{{ __('dashboard.view_all') }}</a>
                                        @elseif(auth()->user()->hasRole('groomer'))
                                            <a href="{{ route('backend.grooming.datatable_view') }}" class="">{{ __('dashboard.view_all') }}</a>
                                        @elseif(auth()->user()->hasRole('walker'))
                                            <a href="{{ route('backend.walking.datatable_view') }}" class="">{{ __('dashboard.view_all') }}</a>
                                        @elseif(auth()->user()->hasRole('trainer'))
                                            <a href="{{ route('backend.training.datatable_view') }}" class="">{{ __('dashboard.view_all') }}</a>
                                        @elseif(auth()->user()->hasRole('day_taker'))
                                            <a href="{{ route('backend.daycare.datatable_view') }}" class="">{{ __('dashboard.view_all') }}</a>
                                        @endif
                                    @endif
                                    </div>
                                            ...
                                            <li class="d-flex align-items-center py-3 border-bottom">
                                                ...
                                                <div class="ms-3 w-100">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <h6 class="mb-2"><a
                                                                href="{{ route('backend.bookings.bookingShow', ['id' => $booking->id]) }}">#{{ $booking->id }}</a>
                                                        </h6>
                                                    ...
                                                    <small>
                                                        {{ date('F j, Y', strtotime($booking->start_date_time)) }} |
                                                        {{ date('h:i A', strtotime($booking->start_date_time)) }}
                                                    </small>
                                                </div>
                                            </li>
                                        @endforeach
                                    ...
                                    @if($data['all_bookings']->isEmpty())
                                        <div class="text-center">
                                        {{ __('messages.data_not_available') }}
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        @if(auth()->user()->hasrole('pet_store'))
                            <div class="col-xl-{{ auth()->user()->roles()->count() == 2 ? '6' : '12' }}">
                                <div class="card">
                                    <div class="card-body ">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <h5 class="card-title mb-0">{{ __('dashboard.all_order') }}</h5>
                                            @if($data['all_order']->isNotEmpty())
                                                <a href="{{ route('backend.orders.index') }}" class="">{{ __('dashboard.view_all') }}</a>
                                            @endif
                                        </div>
                                        <ul class="list-unstyled mb-0">
                                            @foreach ($data['all_order'] as $allOrder)
                                                <li class="d-flex align-items-center py-3 border-bottom">
                                                    <img src="{{ optional(optional($allOrder->order)->user)->profile_image ?? default_user_avatar() }}"
                                                        alt="01" class="rounded-pill avatar avatar-50" loading="lazy">
                                                    <div class="ms-3 w-100">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <h6 class="mb-2"><a
                                                                    href="{{ route('backend.orders.show', ['id' => $allOrder->id]) }}">#{{ optional($allOrder->order)->id }}</a>
                                                            </h6>
                                                            @if ($allOrder->payment_status == 'paid')
                                                                <small class="text-success">{{ __('dashboard.paid') }}</small>
                                                            @elseif($allOrder->payment_status == 'unpaid')
                                                                <small class="text-danger">{{ __('dashboard.unpaid') }}</small>
                                                            @elseif($allOrder->payment_status == 'pending')
                                                                <small class="text-warning">{{ __('dashboard.pending') }}</small>
                                                            {{-- @elseif($allOrder->status == 'confirmed')
                                                                <small class="text-primary">{{ __('dashboard.accepted') }}</small> --}}
                                                            @else
                                                                <small class="text-if">{{ __('dashboard.cancelled') }}</small>
                                                            @endif
                                                        ...
                                                        <small>
                                                            {{ date('F j, Y', strtotime($allOrder->created_at)) }} |
                                                            {{ date('h:i A', strtotime($allOrder->created_at)) }}
                                                        </small>
                                                    </div>
                                                </li>
                                            @endforeach
...
@push('after-scripts')
    ...
    <script>
        ...
        function revanue_chart(type) {
            ...
            var url = Base_url+"/app/get_employee_revnue_chart_data/" + type;
