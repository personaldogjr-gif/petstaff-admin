...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title mb-0">Permissões</h4>
                </div>
                <div>
                    <x-backend.section-header>
                        ...
                        <x-slot name="toolbar">
                            ...
                            <x-buttons.offcanvas target='#form-offcanvas' class=" d-flex align-items-center gap-1"
                                title="{{ __('Criar') }} {{ __('page.lbl_role') }}">{{ __('messages.new') }}
                            </x-buttons.offcanvas>
                            @endhasPermission
                        </x-slot>
                    </x-backend.section-header>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <a data-bs-toggle="collapse" data-bs-target="#demo_{{$module->id}}"
                                                class="accordion-toggle  btn btn-primary btn-xs"><i
                                                    class="fa-solid fa-chevron-down me-2"> </i>Mais</a>
                                        </td>
        ...
        <div data-render="app">
            <manage-role-form create-title="{{ __('Criar') }} {{ __('page.lbl_role') }}">
            </manage-role-form>
