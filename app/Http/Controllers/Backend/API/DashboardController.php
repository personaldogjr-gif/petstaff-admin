...
class DashboardController extends Controller
{
    ...
    public function employeeDashboard(Request $request){
        ...
        $total_trainingservice = ServiceTraining::where('created_by',$employee_id)->count();
        $total_facility = ServiceFacility::where('created_by',$employee_id)->count();
        $total_walker_duration = ServiceDuration::where('type','walking')->where('created_by',$employee_id)->count();
        ...
        $responseData = [
          ...
          'notification_count' => $all_unread_count,
          'total_trainingservice' => $total_trainingservice,
          'total_facility' => $total_facility,
          'total_walker_duration' => $total_walker_duration,
