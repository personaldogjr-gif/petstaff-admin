...
class BackendBaseController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if (request()->wantsJson()) {
            ...
            flash('<i class="fas fa-check"></i> Módulo deletado com sucesso!')->success()->important();
    ...
    public function restore($id)
    {
        ...
        flash('<i class="fas fa-check"></i> Dados restaurados com sucesso!')->success()->important();
