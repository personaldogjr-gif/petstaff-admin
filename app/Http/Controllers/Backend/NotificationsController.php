...
class NotificationsController extends Controller
{
    ...
    public function deleteAll()
    {
        ...
        Flash::success("<i class='fas fa-check'></i> Todas as notificações deletadas")->important();
    ...
    public function markAllAsRead()
    {
        ...
        Flash::success("<i class='fas fa-check'></i> Todas as notificações marcadas como lidas")->important();
