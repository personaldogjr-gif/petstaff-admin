...
class User extends Authenticatable implements HasMedia, MustVerifyEmail
{
    ...
    {
        return $this->hasMany(OrderVendorMapping::class, 'vendor_id')->with('orders');
    }

    public function boarderdaycareamount()
    {
        return $this->hasOne(BoarderDaycareAmount::class);
    }
