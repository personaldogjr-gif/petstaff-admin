...
class CommonNotification extends Notification implements ShouldQueue
{
    ...
    public function Types($type)
    {
        switch ($type) {
            case 'new_booking':
                return $this->type = 'Nova Reserva recebida';
                break;
            case 'accept_booking':
                return $this->type = 'Reserva Aceita';
                break;
            case 'reject_booking':
                return $this->type = 'Reserva Rejeitada';
                break;
            case 'complete_booking':
                return $this->type = 'Reserva Concluída';
                break;
            case 'cancel_booking':
                return $this->type = 'Reserva Cancelada';
                break;
            case 'order_placed':
                return $this->type = 'Pedido Feito';
                break;
            case 'order_accepted':
                return $this->type = 'Pedido Aceito';
                break;
            case 'order_proccessing':
                return $this->type = 'Pedido em Processamento';
                break;
            case 'order_delivered':
                return $this->type = 'Pedido Entregue';
                break;
            case 'order_cancelled':
                return $this->type = 'Order Cancelada';
                break;
            default:
                return $this->type = 'Tipo de Notificação desconhecido';
                break;
        }
    }
}
