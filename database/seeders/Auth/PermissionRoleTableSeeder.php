...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $walker->givePermissionTo(['view_walking','view_walking_booking','view_review','view_owners',"view_owner's_pet",'view_booking_request','view_service','view_walking_duration','add_walking_duration','edit_walking_duration','delete_walking_duration',]);
        $boarder->givePermissionTo(['view_boarding','view_boarding_booking','view_review','view_owners',"view_owner's_pet",'view_service','view_facility','add_facility','edit_facility','delete_facility',]);
        $trainer->givePermissionTo(['view_traning','view_training_booking','view_review','view_owners',"view_owner's_pet",'view_service','view_training_type',
        'add_training_type',
        'edit_training_type',
