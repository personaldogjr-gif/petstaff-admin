    ...
    'app' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'required|min:2', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'admin@gopet.com', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'general', // data type, string, int, boolean
    ...
    'mail' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'GoPet', // default value if you wantPassword
            ],
        ],
    ...
    'other_settings' => [
        ...
        'elements' => [
            ...
            [
                'type' => 'checkbox', // input fields type
                'data' => 'other_settings', // data type, string, int, boolean
                'name' => 'enable_multi_vendor', // unique name for field
                'label' => 'Enable Multiple Vendor', // you know what label it is
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '0', // default value if you want
                'help' => 'Paste the only the Measurement Id of Google Analytics stream.', // Help text for the input field.
            ...
            [
                'type' => 'checkbox', // input fields type
                'data' => 'other_settings', // data type, string, int, boolean
                'name' => 'enable_new_petstore_login', // unique name for field
                'label' => 'Enable PetStore Login', // you know what label it is
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '0', // default value if you want
                'help' => 'Paste the only the Measurement Id of Google Analytics stream.', // Help text for the input field.
            ...
            [
                ...
                'label' => 'Firebase Project Id', // you know what label it is
                'rules' => 'required|min:2', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '', // default value if you want
            ],
            [
                'type' => 'file', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'name' => 'json_file', // unique name for field
                'label' => 'Firebase json', // you know what label it is
                'rules' => 'nullable|mimes:json', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '', // default value if you want
            ],
