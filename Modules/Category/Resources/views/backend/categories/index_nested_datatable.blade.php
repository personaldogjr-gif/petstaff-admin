...
@section('content')
                ...
                <x-slot name="toolbar">
                  ...
                  <div class="input-group flex-nowrap">
                    ...
                    @hasPermission('add_subcategory')
                      <button type="button" class="btn btn-primary d-flex align-items-center gap-1" data-crud-id="{{0}}" title="{{ __('Criar') }} {{ __($module_title) }}"><i class="icon-add-new"></i>{{ __('messages.new') }}</button>
                    @endhasPermission
    ...
    <div data-render="app">
        <form-offcanvas
            ...
            create-title="{{ __('Criar') }} {{ __('nova') }}  Categoria / Subcategoria" edit-title="{{ __('Editar') }} Categoria / Subcategoria"
            create-nested-title="{{ __('Criar') }} {{ __('nova') }}  Sub {{ __($module_title) }}" edit-nested-title="{{ __('Editar') }} Sub {{ __($module_title) }}"
