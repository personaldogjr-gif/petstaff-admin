...
class PlanController extends Controller
{
    ...
    {
        return $this->sendResponse(PlanResource::collection(Plan::with('planLimitation')->get()), 'Lista de planos');
    }
    ...
    public function store(PlanRequest $request)
    {
        ...
        return $this->sendResponse(new PlanResource($plandata), 'Plano criado com sucesso');
    ...
    public function show(Plan $plan)
    {
        ...
        return $this->sendResponse(new PlanResource($plan), 'Detalhes do plano');
    ...
    public function update(PlanRequest $request, Plan $plan)
    {
        ...
        return $this->sendResponse(new PlanResource($plan), 'Plano atualizado com sucesso');
    ...
    public function destroy(Plan $plan)
    {
        ...
        return $this->sendResponse($id, 'Plano deletado com sucesso');
    }
}
