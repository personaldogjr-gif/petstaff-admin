          ...
          <div class="col-12">
            ...
            <div class="form-group" v-if="planlimitation === 'Limited'" id="limitation_data">
              ...
              <a href="/app/subscription/planlimitation"
                ><h6 for="planlimitation_id" style="float: right"><i class="fa fa-plus-circle" aria-hidden="true"></i> Criar Limitação</h6>
              </a>
...
const validationSchema = yup.object({
  name: yup.string()
    ...
    .test('is-string', 'Somente caracteres são permitidos', (value) => !numberRegex.test(value)),
  type: yup.string().required('Tipo é obrigatório'),
  amount: yup.string()
    .required('Quantidade é obrigatório')
    .matches(/^\d+$/, 'Somentes números são permitidos')
    .min(0),
  planlimitation: yup.string().required('Limitação do plano é obrigatório'),
})
