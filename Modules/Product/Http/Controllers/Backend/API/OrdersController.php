        ...
        if (count($carts) > 0) {
            ...
            foreach ($carts as $cart) {
                ...
                if ($cart->qty > $productVariationStock) {
                    $message = $cart->product_variation->product->name. ' está fora de estoque.';
           ...
           // $order->shipping_delivery_type          = $request['shipping_delivery_type'];
            ...
            foreach ($carts as $cart) { 
                ...
                $order_status=[
                    ...
                    'user_id'=>$userId,
                    'note'=>'Seu pedido foi realizado com sucesso.'
            ...
            try {
                ...
                $type = 'order_placed';
                $messageTemplate = 'Seu pedido #[[order_id]] foi realizado com sucesso.';
