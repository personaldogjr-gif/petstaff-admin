            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    <div class="input-group flex-nowrap">
                        <div class="datatable-filter">
                            <select name="variation_rolewise" id="variation_rolewise" class="select2 form-control"
                                data-filter="select" style="width: 100%">
                                <option value="my_variation">
                                    {{ __('messages.my_variation') }}</option>
...
<script type="text/javascript" defer>
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            initDatatable({
                ...
                advanceFilter: () => {
                    return {
                        variation_rolewise: $('#variation_rolewise').val(),
                    }
                }
            });
        })
