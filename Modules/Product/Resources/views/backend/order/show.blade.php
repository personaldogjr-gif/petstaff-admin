                    ...
                    <div class="row justify-content-between align-items-center g-3 mb-4">
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="welcome-message">
                                <h5 class="mb-2">Informações do Cliente</h6>
                                    <p class="mb-0">Nome: <strong>{{ optional(optional($orderItem->order)->user)->full_name }}</strong></p>
                                    <p class="mb-0">Email: <strong>{{ optional(optional($orderItem->order)->user)->email }}</strong></p>
                                    <p class="mb-0">Telefone: <strong>{{ optional(optional($orderItem->order)->user)->mobile }}</strong></p>
                            </div>
                        </div>
