        ...
        <fieldset>
          ...
          <div class="row">
            <div class="form-group col-md-4">
              <div class="text-center">
                ...
                <div class="d-flex align-items-center justify-content-center gap-2">
                  ...
                  <input type="button" class="btn btn-danger" name="remove" value="Remover" @click="removeLogo()" v-if="ImageViewer" />
                </div>
            ...
            <div class="form-group col-md-6">
              ...
              <Multiselect id="categories" v-model="category_ids" :value="category_ids" placeholder="Selecione a categoria" v-bind="multiselectOption" :options="category.options" class="form-group"></Multiselect>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr v-for="(comb, index) in combinations" :key="index">
                      ...
                      <td><input class="form-control" v-model="comb.value.price" type="text" pattern="^(?!0*$)\d+(\.\d+)?$" oninput="this.setCustomValidity(this.value === '0' ? 'Preço deve ser maior que 0' : '')" required/></td>
