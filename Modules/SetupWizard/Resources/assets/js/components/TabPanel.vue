<template>
  <form action="#category">
    ...
    <div class="card-footer">
      <button type="close" class="btn btn-danger iq-text-uppercase" v-if="wizardPrev" @click="nextTabChange(wizardPrev)">Voltar</button>
      <button type="submit" class="btn btn-primary iq-text-uppercase" v-if="wizardNext" @click="nextTabChange(wizardNext)">Próximo</button>
    </div>
  </form>
</template>
<script setup>
