...
@section('content')
    ...
    <div data-render="app">
        ...
        <earning-form-offcanvas create-title="{{ __('Criar') }} {{ __($module_title) }}"
            edit-title="{{ __('Criar') }} {{ __('Pagamento de Funcionários') }} " commission-type="service"></earning-form-offcanvas>
