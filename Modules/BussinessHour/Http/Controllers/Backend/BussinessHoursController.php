...
class BussinessHoursController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        $data = BussinessHour::where('branch_id', $branch_id)->where('type',$type)->get();
    ...
    public function store(Request $request)
    {
        ...
        $weekdays = $data['weekdays'];
         ...
         BussinessHour::where('branch_id', $branch_id)->where('type',$data['type'])->delete();

        foreach($weekdays as $key => $value) {

            $value['branch_id'] = $branch_id;
            $value['type'] = $data['type'];
            BussinessHour::Create($value);
     
        }
        
        $data = BussinessHour::where('branch_id', $branch_id)->where('type', $data['type'])->get();
    ...
    public function destroy($id)
    {
        ...
        if (request()->wantsJson()) {
            ...
            flash('<i class="fas fa-check"></i> Deletado com sucesso!')->success()->important();
