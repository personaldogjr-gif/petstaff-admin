      ...
      <div class="offcanvas-body">
        ...
        <div class="form-group">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="javascript:void(0)" v-if="feature_image" class="text-danger" @click="removeImage">Remover</a>
          </div>
...
const validationSchema = yup.object({
  ...
  duration_min: yup.string().required('Duração do serviço (Mins) é obrigatório').matches(/^[1-9]\d*$/, 'Somentes números positivos são permitidos'),
  default_price: yup.string().required('Preço Padrão é obrigatório').matches(/^[1-9]\d*$/, 'Somentes números positivos são permitidos'),
  category_id: yup.string().required('Categoria é obrigatório').matches(/^\d+$/, 'Somentes números são permitidos'),
