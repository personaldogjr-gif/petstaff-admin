  ...
  <form @submit.prevent="formSubmit">
    <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="service-branch-assign-form" aria-labelledby="form-offcanvasLabel">
        ...
        <div class="form-group">
          <div class="d-grid">
            <div class="d-flex flex-column">
              <div class="form-group">
                <Multiselect v-model="assign_ids" placeholder="Selecionar Filial" :canClear="false" :value="assign_ids" v-bind="branches" @select="selectBranch" @deselect="removeBranch" id="branches_ids">
                  <template v-slot:multiplelabel="{ values }">
                    <div class="multiselect-multiple-label">Selecionar Filial</div>
                  </template>
                </Multiselect>
              </div>
            </div>
      ...
      <div class="offcanvas-footer">
        <p class="text-center mb-0"><small>Atribuir Filial ao serviço</small></p>
