    ...
    public function index_data(Request $request)
    {
        ...
        return Datatables::of($query)
                        ...
                        ->editColumn('duration_list', function ($data) {
                            ...
                            $viewButton = "<b><button type='button' data-assign-module='{$data->id}' data-assign-target='#duration-list' data-assign-event='duration_list' class='btn btn-secondary btn-sm rounded text-nowrap px-1' data-bs-toggle='tooltip' title='Ver Duração'> <i class='fas fa-eye'></i></button></b>";
