...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['web', 'auth']], function () {
   ...
   Route::group(['middleware' => 'permission:view_syetem_service'], function () {
    ...
    Route::group(['prefix' => 'service-training', 'as' => 'service-training.'], function () {
        ...
        Route::get('/duration_list', [ServiceTrainingController::class, 'duration_list'])->name('duration_list');
        Route::get('type-duration-list/{id}', [ServiceTrainingController::class, 'type_duration_list'])->name("type_duration_list");
    });
