    ...
    <form>
      <div class="offcanvas offcanvas-end offcanvas-booking" tabindex="-1" id="pet-notes-form" aria-labelledby="form-offcanvasLabel">
        ...
        <div class="offcanvas-body">
          ...
          <span class="btn btn-sm text-primary border-0 px-0 float-end" data-bs-toggle="offcanvas" data-bs-target="#add-pet-notes-form"  aria-controls="form-offcanvas" > <i class="fa-solid fa-plus"></i> Adicionar Notas</span>
          ...
          <div class="form-group d-inline-block w-100">
            ...
            <div v-else class="text-center"> Processando.... </div>
          </div>
        </div>
      </div>
    </form>
