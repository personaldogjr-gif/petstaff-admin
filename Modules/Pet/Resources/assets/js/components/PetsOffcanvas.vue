...
const validationSchema = yup.object({
  ...
  pettype_id: yup.string().required('Tipo de Pet é obrigatório').matches(/^\d+$/, 'Somente números são permitidos'),
  breed: yup.string().required('Raça é obrigatório'),
  user_id: yup.string().required('User is a required field').matches(/^\d+$/, 'Somente números são permitidos'),
  weight: yup.string().nullable().matches(/^\d*(\.\d+)?$/, 'Somente números são permitidos'),
  height: yup.string().nullable().matches(/^\d*(\.\d+)?$/, 'Somente números são permitidos'),
