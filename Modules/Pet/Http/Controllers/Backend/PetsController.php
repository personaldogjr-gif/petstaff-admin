        ...
        return Datatables::of($query)
                        ...
                        ->editColumn('pet_count', function ($data) {
                            ...
                            if (auth()->user()->can("view_owner's_pet")) {
                                ...
                                $viewButton = "<b><button type='button' data-assign-module='{$data->id}' data-assign-target='#pet-assign-form' data-assign-event='assign_pet' class='btn btn-secondary btn-sm rounded text-nowrap px-1' data-bs-toggle='tooltip' title='Ver todos os Pets'> {$pet_count}</button></b>";
                            }

                            if (auth()->user()->can("add_owner's_pet")) {
                        
                            $addButton = "<button type='button' data-assign-module='{$data->id}' data-assign-target='#add-pet-form' data-assign-event='add_pet' class='btn btn-soft-primary btn-sm rounded text-nowrap px-2' data-bs-toggle='tooltip' title='Criar novo Pet'><i class='fa-solid fa-plus p-0'></i></button>";
                            }
