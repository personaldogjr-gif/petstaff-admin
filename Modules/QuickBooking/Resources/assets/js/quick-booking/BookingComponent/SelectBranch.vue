<template>
    <div class="card-list-data">
                            ...
                            <div class="card-body">
                                <div class="text-center mb-4">
                                    ...
                                    <div class="branch-content mt-3 mt-sm-0">
                                        <h4 class="mb-1">{{ item.name || 'Sem Filial' }}</h4>
        ...
        <div class="h-100 w-75 d-flex align-items-center justify-content-center" v-if="branchList.length == 0 && !IS_LOADER">
          Pedimos desculpas, mas no momento não há agências disponíveis para agendamento de consultas.
        </div>
    </div>
    <div class="card-footer">
      ...
      <button type="button" class="btn btn-primary iq-text-uppercase" :disabled="branch_id !== null ? false : true" v-if="wizardNext" @click="nextTabChange(wizardNext)">Próximo</button>
    </div>
</template>
<script setup>
// Library Import
