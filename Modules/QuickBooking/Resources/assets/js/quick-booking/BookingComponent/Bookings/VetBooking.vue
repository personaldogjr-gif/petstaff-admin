    ...
    <div id="verifyCustomer">
      <form @submit="formSubmit">
        <div class="card-list-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <flat-pickr placeholder="Data" id="date" class="form-control" v-model="date" :value="date"
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="form-label" for="time">{{$t('quick_booking.time')}}<span
                        class="text-danger">*</span></label>
                    <flat-pickr placeholder="Hora" id="time" class="form-control" v-model="time" :value="time"
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <Multiselect id="veterinary_type" v-model="veterinary_type" :value="veterinary_type"
                      @select="getServiceList" placeholder="Selecione a categoria da veterinária" v-bind="SingleSelectOption"
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <Multiselect id="service_id" v-model="service_id" :value="service_id" placeholder="Selecione o Serviço"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <Multiselect id="employee_id" v-model="employee_id" :value="employee_id" placeholder="Selecione o Veterinário"
          ...
          <!-- <button type="button" class="btn btn-secondary iq-text-uppercase" v-if="wizardPrev" @click="prevTabChange(wizardPrev)">Voltar</button> -->
