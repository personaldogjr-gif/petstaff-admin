              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <Multiselect id="service" v-model="service" :value="service" placeholder="Selecione o Serviço"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <Multiselect id="employee_id" v-model="employee_id" :value="employee_id" placeholder="Selecione o Tosador"
