          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <Multiselect id="employee_id" v-model="employee_id" :value="employee_id" placeholder="Selecione o Cuidador" v-bind="SingleSelectOption" :options="employee.options" class="form-group"></Multiselect>
            ...
            <div class="row col-12 m-0">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <flat-pickr placeholder="Data de Retirada" id="pick_up_date" @input="checkTotalAmount" class="form-control" v-model="pick_up_date" :value="pick_up_date" :config="config"></flat-pickr>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <flat-pickr placeholder="Hora de Entrega" id="pick_up_time" class="form-control" v-model="pick_up_time" :value="pick_up_time" :config="config_time"></flat-pickr>
...
const getemployee = (cb) =>
  ...
  const validationSchema = yup.object({
    first_name: yup
      ...
      .test('is-string', 'Somente caracteres são permitidos', (value) => {
    ...
    email: yup.string().required('Email é obrigatório').matches(EMAIL_REGX, 'Deve ser um email válido'),
    mobile: yup
      .string()
      .required('Número de telefone é obrigatório')
      .matches(/^(\+?\d+)?(\s?\d+)*$/, 'Somente números são permitidos')
  })
