<template>
  ...
  <div class="card-footer" v-if="timeSlotList.length > 0">
    ...
    <button type="button" v-if="timeSlotList.length > 0 && wizardNext" class="btn btn-primary iq-text-uppercase" :disabled="start_date_time !== null ? false : true" @click="nextTabChange(wizardNext)">Próximo</button>
  </div>
</template>
<script setup>
