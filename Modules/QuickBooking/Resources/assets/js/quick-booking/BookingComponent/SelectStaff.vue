<template>
    ...
    <div class="col" v-if="user">
      ...
      <div class="user-block bg-white p-3 rounded">
        ...
        <div class="row m-0">
          <label class="col-3 p-0"><i><span class="fst-normal">Telefone</span></i></label>
  ...
  <div class="card-footer" v-if="isFinalstep==1">
    ...
    <button class="btn btn-primary iq-text-uppercase" name="submit" v-if="wizardNext" @click="formSubmit">Enviar</button>
  </div>
</template>
