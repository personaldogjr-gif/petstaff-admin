<template>
  <div class="card-list-data">
                          ...
                          <div class="card-body">
                              <div class="text-center mb-4">
                                  ...
                                  <div class="branch-content mt-3 mt-sm-0">
                                      <h4 class="mb-1">{{ item.name || 'Sim Filial' }}</h4>
      ...
      <div class="h-100 w-75 d-flex align-items-center justify-content-center" v-if="serviceList.length == 0 && !IS_LOADER">
        Pedimos desculpas, mas neste momento não existem serviços disponíveis para marcação de consultas.
      </div>
  </div>
  <div class="card-footer">
    ...
    <button type="button" class="btn btn-primary iq-text-uppercase" :disabled="service_id !== null ? false : true" v-if="wizardNext" @click="nextTabChange(wizardNext)">Próximo</button>
  </div>
</template>
<script setup>
// Library Import
