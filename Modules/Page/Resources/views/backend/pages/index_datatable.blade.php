        ...
        <x-backend.section-header>
            ...
            <x-slot name="toolbar">
                ...
                <div class="input-group flex-nowrap">
                    ...
                    <input type="text" class="form-control form-control-sm dt-search" placeholder="Buscar..."
                        aria-label="Buscar" aria-describedby="addon-wrapping">
                    
                </div>
                @hasPermission('add_page')
                <x-buttons.offcanvas target='#form-offcanvas' class=" d-flex align-items-center gap-1" title="{{ __('Criar') }} {{ __($module_title) }}">
