...
@section('content')
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    <div class="input-group flex-nowrap">
                        <div class="datatable-filter">
                            <select name="tag_rolewise" id="tag_rolewise" class="select2 form-control"
                                data-filter="select" style="width: 100%">
                                <option value="my_tag">
                                    {{ __('messages.my_tag') }}</option>
                    ...
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" class="form-control dt-search" placeholder="Buscar..." aria-label="Buscar"
    ...
    <x-backend.advance-filter>
        ...
        <button type="reset" class="btn btn-danger" id="reset-filter">Resetar</button>
    </x-backend.advance-filter>
@endsection
