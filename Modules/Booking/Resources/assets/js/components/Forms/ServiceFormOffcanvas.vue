<template>
  ...
  const validationSchema = yup.object({
    ...
    duration_min: yup.string().required('Duração do Serviço ( Mins ) é obrigatório').matches(/^\d+$/, 'Somente números são permitidos'),
    default_price: yup.string().required('Preço Padrão é obrigatório').matches(/^\d+$/, 'Somente números são permitidos'),
    category_id: yup.string().required('Categoria é obrigatório').matches(/^\d+$/, 'Somente números são permitidos'),
     description:yup.string().test('no-script-tags', 'Descrição não pode conter script tags.', function(value) {
