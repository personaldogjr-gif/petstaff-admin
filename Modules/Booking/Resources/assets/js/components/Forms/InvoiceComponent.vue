<template>
  <template v-if="bookingData">
    ...
    <div class="offcanvas-body">
      ...
      <div class="py-3">
        ...
        <div>
          <h6><i class="fa-regular fa-clock"></i> Reservado em {{ bookingData.created_at }}</h6>
        </div>
        <div class="">
          <h6><i class="fa-regular fa-user"></i> Reservado por {{ bookingData.created_by_name }}</h6>
        </div>
        <div class="mt-4">
          <h6><i class="fa-regular fa-clock"></i> Atualizado em {{ bookingData.updated_at }}</h6>
        </div>
        <div class="">
          <h6><i class="fa-regular fa-user"></i> Atualizado por {{ bookingData.updated_by_name }}</h6>
        </div>
      </div>
    </div>
  </template>
  <template v-else>
    <div class="offcanvas-header">
      <div>
        <h4>Venda #0 <span class="text-capitalize">(___________)</span></h4>
      </div>
    </div>
  </template>
</template>
