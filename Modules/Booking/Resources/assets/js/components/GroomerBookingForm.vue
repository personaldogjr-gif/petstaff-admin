      ...
      <template v-else-if="SINLGE_STEP == 'MAIN' && status != 'checkout'">
        ...
        <div>
          <div class="d-flex text-center date-time d-none">
            ...
            <div class="col-6 py-3">
              <i>A</i> <strong v-if="start_date_time && start_date_time !== 'Invalid date'">{{ moment(start_date_time).format('HH:mm:ss') }}</strong>
        ...
        <div class="offcanvas-body border-top">
          ...
          <div v-if="selectedCustomer">
            ...
            <div class="col-md-12 form-group">
              ...
              <Multiselect id="service" v-model="service" @select="checkTotalAmount" :value="service" placeholder="Selecione o Serviço" v-bind="SingleSelectOption" :options="service_list.options" class="form-group"></Multiselect>
              <span class="text-danger">{{ errors.service }}</span>
            </div>

            <div class="col-md-12 form-group">
              <label class="form-label">{{ $t('booking.lbl_groomer') }} <span class="text-danger">*</span> </label>
              <Multiselect id="employee_id" v-model="employee_id" :value="employee_id" placeholder="Selecione o Tosador" v-bind="SingleSelectOption" :options="groomer_list.options" class="form-group"></Multiselect>
...
const validationSchema = yup.object({
  ...
  employee_id: yup.string().required('Tosador é obrigatório'),
  service: yup.string().required('Serviços é obrigatório'),
