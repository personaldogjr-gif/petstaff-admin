<template>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <Multiselect id="veterinary_type" v-model="veterinary_type" :value="veterinary_type" @select="getServiceList" placeholder="Selecione a categoria veterinária" v-bind="SingleSelectOption" :options="veterinary_type_list.options" class="form-group"></Multiselect>
  ...
  <CategoryFormOffcanvas createTitle="Criar Nova Categoria / Subcategoria"></CategoryFormOffcanvas>
  <ServiceFormOffcanvas createTitle="Criar Serviço"></ServiceFormOffcanvas>
...
const validationSchema = yup.object({
  ...
  veterinary_type: yup.string().required('Tipo de veterinário é obrigatório'),
  employee_id: yup.string().required('Veterinário é obrigatório'),
  service_id: yup.string().required('Serviço é obrigatório')
})
