        ...
        <div class="offcanvas-body border-top">
          ...
          <div v-if="selectedCustomer">
            ...
            <div class="col-md-12 form-group">
              ...
              <Multiselect id="employee_id" v-model="employee_id" :value="employee_id" @select="getDurationList" placeholder="Selecione o Passeador" v-bind="SingleSelectOption" :options="walker_list.options" class="form-group"></Multiselect>
            ...
            <div class="col-md-12 form-group">
              ...
              <Multiselect id="duration" v-model="duration" :value="duration"  @select="checkTotalAmount"  placeholder="Selecione a Duração" v-bind="SingleSelectOption" :options="duration_list.options" class="form-group"></Multiselect>
...
const validationSchema = yup.object({
  ...
  employee_id: yup.string().required('Passeador é obrigatório'),
