            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <Multiselect id="employee_id" v-model="employee_id" :value="employee_id" placeholder="Selecione o cuidador" v-bind="SingleSelectOption" @select="onEmployeeChange" :options="employee.options" class="form-group"></Multiselect>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <Multiselect id="facility" v-model="facility" :multiple="true" :value="facility" placeholder="Selecione a Facilidade" v-bind="multiSelectOption" :options="facility_list.options" class="form-group"> </Multiselect>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <flat-pickr placeholder="Data de entrega" id="drop_off_date" class="form-control" @input="checkTotalAmount" v-model="drop_off_date" :value="drop_off_date" :config="config"></flat-pickr>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <flat-pickr placeholder="Hora de entrega" id="drop_off_time" class="form-control" v-model="drop_off_time" :value="drop_off_time" :config="config_time"></flat-pickr>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <flat-pickr placeholder="Data da retirada" id="pick_up_date" @input="checkTotalAmount" class="form-control" v-model="pick_up_date" :value="pick_up_date" :config="config"></flat-pickr>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <flat-pickr placeholder="Hora da retirada" id="pick_up_time" class="form-control" v-model="pick_up_time" :value="pick_up_time" :config="config_time"></flat-pickr>
...
const getBookingprice = (employeeId) => {
  const type = 'pet_boarding_amount'

  listingRequest({ url: BOOKING_PRICE, data: { type: type, employee_id:employeeId } }).then((res) => {
    if (res.data) {
...
const getFacilityList = (employeeId) => {
  facility.value = [];
  useSelect({ url: FACILITY_LIST , data: { employee_id:employeeId }}, { value: 'slug', label: 'name' }).then((data) => (facility_list.value = data))
}
...
const validationSchema = yup.object({
  ...
  pet: yup.string().required('Selecione Pet é obrigatório'),
  drop_off_date: yup.string().required('Data de entrega é obrigatória'),
  drop_off_time: yup.string().required('Hora de entrega é obrigatória'),
  pick_up_date: yup
    .string()
  ...
  // pick_up_date: yup.string().required('Data de entrega é obrigatória'),
  pick_up_time: yup.string().required('Hora de entrega é obrigatória'),
  // drop_off_address: yup.string().required('Endereço é obrigatório'),
  // pick_up_address: yup.string().required('Endereço de retirada é obrigatório'),
  employee_id: yup.string().required('Cuidador é obrigatório')
})
...
const getemployee = (cb) =>
  useSelect({ url: EMPLOYEE_LIST }, { value: 'id', label: 'full_name' }).then((data) => {
    ...
    const employeeId = employee.value.list.length ? employee.value.list[0].id : null;
    if (employeeId) {
  ...
  const onEmployeeChange = (employeeId) => {
    getBookingprice(employeeId);
    getFacilityList(employeeId);
  };
