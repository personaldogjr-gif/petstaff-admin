...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        const columns = [
            ...
            { data: 'status', name: 'status', orderable: false, searchable: true, title: "{{ __('constant.lbl_status') }}" },
            { data: 'updated_at', name: 'updated_at',  title: "{{ __('constant.lbl_updated_at') }}" },
        ]

        const actionColumn = [
            { data: 'action', name: 'action', orderable: false, searchable: false, title: "{{ __('constant.lbl_action') }}" }
        ]
