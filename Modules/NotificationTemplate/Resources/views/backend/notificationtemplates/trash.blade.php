        ...
        <div class="card-body">
            ...
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    <a href='{{ route("backend.notification-templates.index") }}' class="btn btn-secondary" data-bs-toggle="tooltip"
                        title="{{ __($module_name) }} Lista"><i class="fas fa-list"></i> Lista</a>
                </x-slot>
            </x-backend.section-header>
