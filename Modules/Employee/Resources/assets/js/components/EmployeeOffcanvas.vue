        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
              ...
              <div class="d-flex align-items-center justify-content-center gap-2">
                ...
                <input type="button" class="btn btn-soft-danger" name="remove" value="Remover" @click="removeLogo()"
                  v-if="ImageViewer" />
              </div>
            ...
            <div class="form-group col-md-12">
              ...
              <Multiselect id="commission_id" v-model="commission_id" :value="commission_id"
                placeholder="Selecione a comissão" v-bind="multiselectOption" :options="commissions.options"
            ...
            <div class="col-md-6 form-group d-none" v-if="type !='staff'">  
              ...
              <select class="form-select" placeholder="Select o tipo de usuário" v-model="user_type" :disabled="user_type != 'staff'">
                <option value="vet">{{$t('employee.vet')}}</option>
                <option value="trainer">{{$t('employee.trainer')}}</option>
                <option value="groomer">{{$t('employee.groomer')}}</option>
                <option value="walker">{{$t('employee.walker')}}</option>
            ...
            <div class="col-md-6 form-group">
              ...
              <Multiselect id="branch_id" v-model="branch_id" :value="branch_id" placeholder="Selecione o Centro Pet"
            ...
            <!-- <div class="form-group">
              <label class="form-label" for="branch">{{ $t('employee.lbl_select_branch') }}</label>
              <Multiselect id="branch_id" v-model="branch_id" :value="branch_id" placeholder="Selecione a filial"
                v-bind="singleSelectOption" :options="branch.options" @select="branchSelect" class="form-group">
              </Multiselect>
              <span v-if="errorMessages['branch_id']">
                <ul class="text-danger">
            ...
            <div class="form-group" v-if="type=='groomer' ||type=='vet' ">
              ...
              <Multiselect id="service_id" v-model="service_id" :multiple="true" :value="service_id"
                placeholder="Selecione o Serviço" v-bind="multiSelectOption" :options="services.options" class="form-group">
              </Multiselect>
