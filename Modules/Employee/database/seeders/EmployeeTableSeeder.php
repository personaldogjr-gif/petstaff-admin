...
class EmployeeTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $employee = [
            [
              ...
              'feature_image' => '/dummy-images/profile/boarder/Amalia.png',
            ...
            [
                ...
                'feature_image' => '/dummy-images/profile/boarder/Julian.png',
                'password' => Hash::make('12345678'),
                'mobile' => '1-4515478568',
                'gender' => 'male',
                'email_verified_at' => Carbon::now(),
        ...
        if (env('IS_DUMMY_DATA')) {
            ...
            foreach ($employee  as $key => $employee_data) {
                ...
                $existingEmployee = User::where('email', $employee_data['email'])->first();
                if ($existingEmployee) {
                    \Log::info('Employee already exists, skipping: ' . $employee_data['email']);
                    continue;
                }
    ...
    private function dummyReview($emp_id) {
        $employeerating = [
            [
                'employee_id' => $emp_id,
                'user_id' => Carbon::now()->subYears(25)->format('Y-m-d')->numberBetween(2, 40),
                'review_msg' => 'Awesome service',
                'rating' => Carbon::now()->subYears(25)->format('Y-m-d')->numberBetween(3, 5),
            ],
            [
                'employee_id' => $emp_id,
                'user_id' => Carbon::now()->subYears(25)->format('Y-m-d')->numberBetween(2, 40),
